...
/**
 * @title DummyUpgradeUSDC_Whitelist - Time-Based Automated Insurance Contract with USDC Support and Simple Whitelist
 * @dev Enhanced insurance contract with Chainlink Time-based Automation, USDC reserves, and seller-controlled whitelist
 * 
 * Features:
 ...
 */
contract DummyUpgradeUSDC_Whitelist is ReentrancyGuard, Ownable {
    ...
    /**
     * @dev Add buyer to contract whitelist (only seller)
     * @param _contractId Contract ID
     * @param _buyer Buyer address to whitelist
     */
    function addBuyerToWhitelist(uint256 _contractId, address _buyer) external onlyContractSeller(_contractId) {
    ...
    /**
     * @dev Remove buyer from contract whitelist (only seller)
     * @param _contractId Contract ID
     * @param _buyer Buyer address to remove
     */
    function removeBuyerFromWhitelist(uint256 _contractId, address _buyer) external onlyContractSeller(_contractId) {
    ...
    /**
     * @dev Batch add buyers to contract whitelist (only seller)
     * @param _contractId Contract ID
     * @param _buyers Array of buyer addresses to whitelist
     */
    function batchAddBuyersToWhitelist(uint256 _contractId, address[] calldata _buyers) external onlyContractSeller(_contractId) {
        require(contracts[_contractId].whitelistEnabled, "Whitelist not enabled for this contract");
    ...
    /**
     * @dev Batch remove buyers from contract whitelist (only seller)
     * @param _contractId Contract ID
     * @param _buyers Array of buyer addresses to remove
     */
    function batchRemoveBuyersFromWhitelist(uint256 _contractId, address[] calldata _buyers) external onlyContractSeller(_contractId) {
     ...
     */
    function setContractWhitelistStatus(uint256 _contractId, bool _enabled) external onlyContractSeller(_contractId) {
        Contract storage c = contracts[_contractId];
    ...
    /**
     * @dev Allow contract to receive AVAX for emergency testing
     */
